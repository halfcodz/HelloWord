            ...
            children: [
              ...
              if (total == 0)
                ...
                Row(
                  ...
                  children: [
                    _RoundCardButton(onTap: () => _advance(memorized: false)),
                    SizedBox(width: 20.w),
                    _RoundCardButton(
                      primary: true,
...
class _RoundCardButton extends StatelessWidget {
  const _RoundCardButton({required this.onTap, this.primary = false});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        alignment: Alignment.center,
        decoration: BoxDecoration(
          color: primary ? AppColors.pink : AppColors.cream,
          ...
          boxShadow: [
            BoxShadow(
              color: (primary ? AppColors.mint : AppColors.navy).withValues(
                alpha: primary ? 0.4 : 0.12,
              ),
